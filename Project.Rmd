...
totalCorHeap = rbind.data.frame(corHeap, corHeap_excluded[-1, ])
...
Si nota che più l'area del Piano terra, più il prezzo tende ad aumentare. Si nota oltre che si ha maggior densità di vendite quando le case sono comprese tra `r quantile(GrLivArea,probs=0.25)` e `r quantile(GrLivArea,probs=0.75)` oltre al quale diventa sparsa. Questo aumento puo essere causato dal incertezza su quale valore attribuire a un piano piu grande.
...
Si deduce che più bagni si ha, più il prezzo tende a aumentare. È possibile che questo sia dovuto al fatto che le persone associano alla qualità un prezzo superiore.
...
Si deduce che più Stanze si ha, più il prezzo tende a aumentare. È possibile che questo sia dovuto al fatto che le persone associano a Stanze un prezzo superiore. Si puo osservare degli outlier a 2 e 14  Stanze dovute alle mancanza dei dati (esiste un solo dato per ognuna).
...
Si deduce che più Camini si ha, più il prezzo tende a aumentare. È possibile che questo sia dovuto al fatto che le persone associano a Camini un prezzo superiore.
...
```
Si deduce che più nuovo il garage è, più il prezzo tende ad aumentare. È possibile che questo sia dovuto al fatto che le persone associano ai garage piu nuovi un prezzo superiore.
...
```
Si deduce che più auto che possono stare nel garage, più il prezzo tende ad aumentare. È possibile che questo sia dovuto al fatto che le persone associano ai posti auto un prezzo superiore.
...
```
Si deduce che più grande è il garage, più il prezzo tende ad aumentare. È possibile che questo sia dovuto al fatto che le persone associano al area del garage un prezzo superiore. Si nota che con un garage di 0m^2, quindi nessun garage, il prezzo tende ad essere minore
