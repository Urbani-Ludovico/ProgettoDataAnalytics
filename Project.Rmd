...
## Analisi dell'area del primo piano

``` {r, message = F, warning = F}
mod <- analysis.quantitative(
    SalePrice, X1stFlrSF,
    second_var.lab = "area del primo piano"
)
```
...
## Analisi dell'area totale con il numero totale di stanze
...
## Analisi dell'area del piano terra con il numero di bagni
