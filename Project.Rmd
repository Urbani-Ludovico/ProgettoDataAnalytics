...
e filtrarlo per avere solo le variabili che hanno correlazione con SalePrice >=0.5
``` {r,warning = F}
par(mfrow = c(2, 3))
for (var in rownames(corHeap)[rownames(corHeap) != "SalePrice" & abs(corHeap)>=0.5]){
