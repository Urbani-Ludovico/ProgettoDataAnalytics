...
p3 = ggcorrplot(third_half_corHeap, type = "lower", lab = TRUE, lab_size = 2.3) +
  theme(
  axis.text.x = element_text(size = 7),
  axis.text.y = element_text(size = 7)
  )
...
```{r, warning = F}
vars <- c("SalePrice", "FrontageExists", "LotShapeLess", "HouseAge", "GarageExists", "OpenPorchExists", "EnclosedPorchExists", "ScreenPorchExists")
