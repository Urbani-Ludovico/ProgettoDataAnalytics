...
ggplot(HP, aes(x = YearRemodAdd, y = log(SalePrice), color = factor(OverallQual))) +
    geom_point() +
    labs(x = "ultimi lavori eseguiti (anno)", y = "prezzo di vendita", color = "Qualità complessiva") +
    theme_minimal()

ggpairs(table(factor(HP$OverallQual), log(HP$SalePrice)))
```
