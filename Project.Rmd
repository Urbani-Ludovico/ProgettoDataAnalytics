...
Prendo le variabili escluse dal pair plot come e provo a creare delle variabili calcolate che potrebbero essere correlate a SalePrice. 
...
```{r, warning = F}
vars <- c("SalePrice", "FrontageExists", "AlleyExists", "LotShapeLess", "HouseAge", "TotalBaths", "GarageExists", "OpenPorchExists", "EnclosedPorchExists", "ScreenPorchExists", "FireplacesExists", "FenceExists")
